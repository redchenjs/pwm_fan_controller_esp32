...
LLDSPEC bool_t gdisp_lld_init(GDisplay *g) {
    ...
    LLDSPEC void gdisp_lld_write_color(GDisplay *g) {
        ...
        switch (g->g.Orientation) {
            case GDISP_ROTATE_0:
            default:
                pos = stream_write_y * g->g.Width + stream_write_x;
                break;
            case GDISP_ROTATE_90:
                pos = (g->g.Width-stream_write_x-1) * g->g.Height + stream_write_y;
                break;
            case GDISP_ROTATE_180:
                pos = (g->g.Height-stream_write_y-1) * g->g.Width + g->g.Width-stream_write_x-1;
                break;
            case GDISP_ROTATE_270:
                pos = stream_write_x * g->g.Height + g->g.Height-stream_write_y-1;
                break;
        }
    ...
    LLDSPEC color_t gdisp_lld_read_color(GDisplay *g) {
        ...
        switch (g->g.Orientation) {
            case GDISP_ROTATE_0:
            default:
                pos = stream_read_y * g->g.Width + stream_read_x;
                break;
            case GDISP_ROTATE_90:
                pos = (g->g.Width-stream_read_x-1) * g->g.Height + stream_read_y;
                break;
            case GDISP_ROTATE_180:
                pos = (g->g.Height-stream_read_y-1) * g->g.Width + g->g.Width-stream_read_x-1;
                break;
            case GDISP_ROTATE_270:
                pos = stream_read_x * g->g.Height + g->g.Height-stream_read_y-1;
                break;
        }
